...
import { Trash2 as X } from "lucide-react";
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "h-6 p-1 justify-between items-center  cursor-pointer ",
                className,
                isSelected ? "bg-muted" : "",
            )}
            {...props}
        >
            ...
            >
                ...
                <X className="w-6 h-6 hover:stroke-destructive duration-200 ease-in-out" />
