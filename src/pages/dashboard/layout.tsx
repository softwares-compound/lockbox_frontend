    ...
    return (
        <div className="text-base md:text-xl lg:text-xl">
            <nav className="flex items-center justify-between px-2 md:px-4 py-2 h-[10vh] bg-white dark:bg-gray-800">
                <a onClick={() => navigate('/dashboard/create-transaction')} className="flex items-center gap-2">
                    <img
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:block">
                        <Button variant="default" onClick={() => navigate('/dashboard/create-transaction')}>Create new transactions</Button>
                    </div>
                    <Sheet>
                        ...
                        <SheetContent side="right" className="border-0 rounded-l-3xl">
                            <div className="w-full flex flex-col gap-4 md:gap-6 mt-4">
                                ...
                                <div className="flex flex-col gap-2 md:gap-4">
                                    <button onClick={() => navigate('/dashboard/create-transaction')} className="text-start text-base md:text-xl font-medium p-2 text-brand hover:bg-brand/20 rounded-3xl">
                                    ...
                                    <button onClick={() => navigate('/dashboard/create-transaction')} className="text-start md:hidden text-base md:text-xl font-medium p-2 text-brand hover:bg-brand/20 rounded-3xl">
                                        Transaction drafts
                                    </button>
                                    <button onClick={() => navigate('/dashboard/create-transaction')} className="text-start md:hidden text-base md:text-xl font-medium p-2 text-brand hover:bg-brand/20 rounded-3xl">
                            ...
                            <footer className="mt-[5vh] text-center text-base md:text-base">
                                <p>Not you? <span><button onClick={() => navigate('/dashboard/create-transaction')} className="text-brand hover:underline">Logout</button></span></p>
                            </footer>
                        </SheetContent>
                    </Sheet>
                </div>
